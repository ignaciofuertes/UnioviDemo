CREATE DATABASE  IF NOT EXISTS `Uniovi` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `Uniovi`;
-- MySQL dump 10.13  Distrib 5.6.17, for osx10.6 (i386)
--
-- Host: 10.0.52.174    Database: Uniovi
-- ------------------------------------------------------
...
INSERT INTO `Car` VALUES (1,'Uniovi Yaris 2015',14845.00),(2,'Uniovi Corolla 2015',16900.00),(3,'Uniovi Avalon',32560.00);
